<template>
  <div class="mt-4">
    <h2 class="text-center">Berkata</h2>
    <form class="detail-box my-5">
      <div class="form-group my-3">
        <h4 class="text-center">Signup to Chat</h4>
        <input
          type="text"
          v-model="name"
        ...
        />
        <router-link :to="{ path: '/' }" class="text-center">
        ...
        <button
          ...
          type="button"
          v-on:click="signup"
          class="btn btn-primary btn-block input-block-level form-control"
        >Signup</button>
      </div>
    </form>
  </div>
